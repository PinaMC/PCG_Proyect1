...
public static class PerlinNoiseGenerator
{
        ...
        HeightmapGenerator.InterpolationMode interpolationMode)
    {
        ...
        // 2. Calcular localX y localY (posición fraccional dentro de la celda).
        float localX = x - x0;
        float localY = y - y0;

        // 3. Obtener el gradiente correspondiente a cada esquina.
        Vector2 g00 = GetGradient(x0, y0, seed); // Esquina Superior Izquierda
        Vector2 g10 = GetGradient(x1, y0, seed); // Esquina Superior Derecha
        Vector2 g01 = GetGradient(x0, y1, seed); // Esquina Inferior Izquierda
        Vector2 g11 = GetGradient(x1, y1, seed); // Esquina Inferior Derecha

        // 4. Crear los cuatro vectores de desplazamiento (punto - esquina).
        ...
        //se delega a una funcion externa del heightmap generator para obtener el peso de interpolacion
        ...
        // 7 y 8. Interpolar horizontalmente los dos resultados superiores e inferiores.
        ...
        float noiseValue = HeightmapGenerator.LinearInterpolation(top, bottom, weightY);
